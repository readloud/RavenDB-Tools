...
> RavenDB is one of the first non-relational databases to offer [ACID](https://ravendb.net/why-ravendb/acid-transactions) not just for a single document, but for multiple documents throughout the entire database.
...
RavenDB Advanced Best [Practices](https://workshops.ravendb.net/) and Performance
